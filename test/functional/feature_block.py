...
class FullBlockTest(LightcoinTestFramework):
    ...
    def run_test(self):
        ...
        # lightcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the lightcoin code has custom code which does so);
