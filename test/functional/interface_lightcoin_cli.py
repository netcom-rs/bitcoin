...
class TestLightcoinCli(LightcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and lightcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test lightcoin-cli -generate with -rpcwallet in multiwallet mode.
