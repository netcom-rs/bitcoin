...
class TestShell:
    """Wrapper Class for LightcoinTestFramework.

    The TestShell class extends the LightcoinTestFramework
    ...
    class __TestShell(LightcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by LightcoinTestFramework child class.
            self.num_nodes = 1
