...
"""Test objects for interacting with a lightcoind node over the p2p protocol.

The P2PInterface objects interact with the lightcoind nodes under test using the
