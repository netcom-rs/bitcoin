...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/lightcoin/lightcoin/pull/14884#discussion_r239585126).
...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the LightcoinTestFramework, place overrides for the
...
The [`TestShell`](test-shell.md) class exposes the LightcoinTestFramework
...
Taken from the [python-lightcoinrpc repository](https://github.com/jgarzik/python-lightcoinrpc).
...
Test objects for interacting with a lightcoind node over the p2p interface.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-lightcoinlib)
