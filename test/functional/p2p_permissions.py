...
class P2PPermissionsTests(LightcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].lightcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].lightcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
