...
#ifndef LIGHTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define LIGHTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // LIGHTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
