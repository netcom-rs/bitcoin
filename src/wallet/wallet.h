...
#ifndef LIGHTCOIN_WALLET_WALLET_H
#define LIGHTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this lightcoin node, and set to 0 for transactions that were created
...
#endif // LIGHTCOIN_WALLET_WALLET_H
