...
#ifndef LIGHTCOIN_WALLET_WALLETUTIL_H
#define LIGHTCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! lightcoin from opening the wallet, thinking it was newly created, and
...
#endif // LIGHTCOIN_WALLET_WALLETUTIL_H
