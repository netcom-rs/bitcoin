...
#ifndef LIGHTCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define LIGHTCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Lightcoin Core wallet was originally a collection of unrelated private
...
#endif // LIGHTCOIN_WALLET_SCRIPTPUBKEYMAN_H
