    ...
    platformStyle(_platformStyle)
{
    ...
    // normal lightcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying lightcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &LightcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
