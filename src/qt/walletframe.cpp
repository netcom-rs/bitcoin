...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, LightcoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &LightcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &LightcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &LightcoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &LightcoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &LightcoinGUI::updateWalletStatus);
    connect(gui, &LightcoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
