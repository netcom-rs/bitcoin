...
//! Entry point for LightcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &LightcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for LightcoinGUI tests.
void AppTests::guiTests(LightcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &LightcoinGUI::consoleShown, this, &AppTests::consoleTests);
