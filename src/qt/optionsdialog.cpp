    ...
    mapper(nullptr)
{
    ...
    ui->lightcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->lightcoinAtStartup);
    ...
    ui->lightcoinAtStartup->setToolTip(ui->lightcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->lightcoinAtStartup->setText(ui->lightcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openLightcoinConfButton->setToolTip(ui->openLightcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new LightcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->lightcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLightcoinConfButton_clicked()
{
