...
#ifndef LIGHTCOIN_UTIL_SETTINGS_H
#define LIGHTCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/lightcoin/lightcoin/pull/15934/files#r337691812)
...
#endif // LIGHTCOIN_UTIL_SETTINGS_H
