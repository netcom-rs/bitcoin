...
#ifndef LIGHTCOIN_UTIL_MESSAGE_H
#define LIGHTCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's lightcoin address, it must refer to a public key.
...
#endif // LIGHTCOIN_UTIL_MESSAGE_H
