...
#ifndef LIGHTCOIN_TEST_SCRIPTNUM10_H
#define LIGHTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Lightcoin Core 0.10.0, for cross-comparison.
 */
public:
