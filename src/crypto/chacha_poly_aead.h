...
#ifndef LIGHTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define LIGHTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@lightcoin.
 *
 ...
 *
 * The chacha20-poly1305@lightcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@lightcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@lightcoin are relatively fast in
...
#endif // LIGHTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
