...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Lightcoin
else
  DOCKER_EXEC echo \> \$HOME/.lightcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/lightcoin/lightcoin/pull/18288#discussion_r433189350 for
  # details.
