# Bootstrappable Lightcoin Core Builds

This directory contains the files necessary to perform bootstrappable Lightcoin
Core builds.
...
- 24GB of free disk space on the partition that the Lightcoin Core git repository
  resides in
...
For a Lightcoin Core depends development environment, simply invoke
...
From the top of a clean Lightcoin Core repository:
...
To use dongcarl's substitute server for Lightcoin Core builds after having
