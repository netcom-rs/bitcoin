...
// lightcoin includes.
#include <..\src\script\lightcoinconsensus.h>
...
int main()
{
    std::cout << "lightcoinconsensus version: " << lightcoinconsensus_version() << std::endl;
    ...
    auto op0Result = lightcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, lightcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
