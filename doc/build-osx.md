...
To build Lightcoin Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Lightcoin Core may be
...
The first time you run lightcoind, it will start downloading the blockchain. This process could
...
processors only.
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/lightcoin/lightcoin/issues/7714).
