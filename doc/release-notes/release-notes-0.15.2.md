Lightcoin Core version *0.15.2* is now available from:

  <https://lightcoincore.org/bin/lightcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in lightcoin-tx (TheBlueMatt)
