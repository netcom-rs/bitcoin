Lightcoin Core version *0.14.3* is now available from:

  <https://lightcoin.org/bin/lightcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/lightcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
