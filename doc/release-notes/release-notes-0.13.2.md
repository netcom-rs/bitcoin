Lightcoin Core version 0.13.2 is now available from:
  ...
  <https://lightcoin.org/bin/lightcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update lightcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow lightcoin-tx to create v2 transactions (btcdrak)
