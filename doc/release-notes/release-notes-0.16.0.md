Lightcoin Core version 0.16.0 is now available from:
  ...
  <https://lightcoincore.org/bin/lightcoin-core-0.16.0/>
...
- #11917 `bc66765` Add testnet DNS seed:  seed.testnet.lightcoin.sprovoost.nl (Sjors)
...
- #11970 `b7450cd` Add test coverage for lightcoin-cli multiwallet calls (ryanofsky)
...
- #10997 `affe927` Add option -stdinrpcpass to lightcoin-cli to allow RPC password to be read from standard input (jharvell)
...
- #11621 `1f7695b` [build] Add temp_lightcoin_locale_qrc to CLEAN_QT to fix make distcheck (fanquake)
...
- #11711 `6378e5c` lightcoin_qt.m4: Minor fixes and clean-ups (fanquake)
...
- #11297 `16e4184` Make sure ~/.lightcoin doesn't exist before build (MeshCollider)
...
- #11143 `3aa60b7` Fix include path for lightcoin-config.h (danra)
...
- #10871 `c9a4aa8` Handle getinfo in lightcoin-cli w/ -getinfo (revival of #8843) (achow101)
- #11419 `093074b` Utils: Fix launchctl not being able to stop lightcoind (OmeGak)
...
- #10529 `331352f` Improve lightcoind systemd service file (Flowdalic)
