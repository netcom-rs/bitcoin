Lightcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/lightcoin/files/Lightcoin/lightcoin-0.5.4/
...
http://gitorious.org/lightcoin/lightcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Lightcoin-Qt notifications under Growl 1.3.
Increase required age of Lightcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLightcoin properly when installing Lightcoin-Qt over it. (Windows)
