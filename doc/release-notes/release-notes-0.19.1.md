...
Lightcoin Core version 0.19.1 is now available from:

  <https://lightcoincore.org/bin/lightcoin-core-0.19.1/>
...
From Lightcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Lightcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Lightcoin Core does not yet change appearance when
...
- #17488 fix "lightcoind already running" warnings on macOS (fanquake)
