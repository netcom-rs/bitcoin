Lightcoin Core version 0.14.0 is now available from:

  <https://lightcoin.org/bin/lightcoin-core-0.14.0/>
...
Lightcoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/lightcoin/lightcoin/blob/master/doc/zmq.md) for
...
The Alert System was [disabled and deprecated](https://lightcoin.org/en/alert/2016-11-01-alert-retirement) in Lightcoin Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/lightcoin/lightcoin/pull/8753)
...
- #8722 `bb843ad` lightcoin-cli: More detailed error reporting (laanwj)
...
- #8830 `ef0801b` test: Add option to run lightcoin-util-test.py manually (jnewbery)
- #8881 `e66cc1d` Add some verbose logging to lightcoin-util-test.py (jnewbery)
...
- #9023 `774db92` Add logging to lightcoin-util-test.py (jnewbery)
- #9065 `c9bdf9a` Merge `doc/unit-tests.md` into `src/test/README.md` (laanwj)
- #9069 `ed64bce` Clean up bctest.py and lightcoin-util-test.py (jnewbery)
...
- #9691 `fc67cd2` Init ECC context for `test_lightcoin_fuzzy` (gmaxwell)
...
- #9865 `289204f` Change lightcoin address in RPC help message (marijnfs)
...
- #8813 `fb24d7e` lightcoind: Daemonize using daemon(3) (laanwj)
...
- #8837 `2108911` Allow lightcoin-tx to parse partial transactions (jnewbery)
- #9204 `74ced54` Clarify CreateTransaction error messages (instagibbs)
- #9265 `31bcc66` lightcoin-cli: Make error message less confusing (laanwj)
...
- #8883 `d5d4ad8` Add all standard TXO types to lightcoin-tx (jnewbery)
