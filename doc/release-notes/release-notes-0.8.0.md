Lightcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lightcoin/files/Lightcoin/lightcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Lightcoin
...
New/changed settings (command-line or lightcoin.conf file)
--------------------------------------------------------
