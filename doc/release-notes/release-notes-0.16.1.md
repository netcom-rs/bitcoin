Lightcoin Core version 0.16.1 is now available from:

  <https://lightcoincore.org/bin/lightcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting lightcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure lightcoind processes are cleaned up when tests end (sdaftuar)
