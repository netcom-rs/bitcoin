Lightcoin Core version 0.10.4 is now available from:

  <https://lightcoin.org/bin/lightcoin-core-0.10.4/>
...
- #6953 `43c2789` Split lightcoin-tx into its own package
- #6953 `dfe0d4d` Include lightcoin-tx binary on Debian/Ubuntu
