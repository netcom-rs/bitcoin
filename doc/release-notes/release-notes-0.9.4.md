Lightcoin Core version 0.9.4 is now available from:

  https://lightcoin.org/bin/0.9.4/
...
this update is incompatible with the Lightcoin system and could lead to consensus
forks.

Lightcoin Core released binaries from https://lightcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lightcoin/+archive/ubuntu/lightcoin
- A third-party or self-compiled Lightcoin Core

upgrade to Lightcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
